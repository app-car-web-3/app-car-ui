                        ...
                        <ul className="space-y-2 font-medium">
                            ...
                            <li>
                                <a href="/admin/cars" className="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
                                    <svg className={`flex-shrink-0 w-5 h-5 text-white transition duration-75 group-hover:text-gray-300 block py-2 px-3 rounded md:p-0 ${pathname === '/admin/cars' ? 'text-orange bg-orange-700 md:bg-transparent md:text-orange-700 dark:text-white md:dark:text-orange-500' : 'text-white hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-orange-700 dark:text-white md:dark:hover:text-orange-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent'}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
